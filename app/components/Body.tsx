  ...
  return (
    <>
      <div className="space-y-10 py-5">
        ...
        <section className="bg-dark flex flex-col w-full h-full font-poppins !font-light rounded-md shadow-md animate-fadeIn delay-50">
          <div className="flex w-full text-white">
            <div className="bg-[#2f1b12] w-1/2 h-full flex flex-col items-center">
              ...
              <Image
                src="https://assets.splitwise.com/assets/home_page/fixtures/asset1-b7eef5474a87c4fa99310094be435f18d83a7e87427b0d035cf9fd5382a92e12.png" alt="Track Balance"
                className="mt-8"
                layout="intrinsic"
                width={300}
              height={100}
            ...
            <div className="bg-[#deaf84] w-1/2 h-full flex flex-col items-center">
              ...
              <Image
                src="https://assets.splitwise.com/assets/home_page/fixtures/asset3-d1bdfeae0e4d9a89351d416b3991160e38c2391cd0db26f6c6cb0331649fa92c.png" alt="Organize expenses"
                className="mt-8"
                layout="intrinsic"
                width={300}
              height={100}
          ...
          <div className="flex w-full">
            <div className="bg-[#97704f] w-1/2 h-full flex flex-col items-center">
              ...
              <Image
                src="https://assets.splitwise.com/assets/home_page/fixtures/asset3-d1bdfeae0e4d9a89351d416b3991160e38c2391cd0db26f6c6cb0331649fa92c.png" alt="Add expenses easily"
                className="mt-8"
                layout="intrinsic"
                width={300}
              height={100}
            ...
            <div className="bg-[#43392f] w-1/2 h-full flex flex-col items-center">
              ...
              <Image
                src="https://assets.splitwise.com/assets/home_page/fixtures/asset4-3abaa95d20d133c1948fa1e3d8047890c3d7e274130cfcba5c2a304f74aa1353.png" alt="Pay friends back"
                className="mt-8"
                layout="intrinsic"
                width={300}
              height={100}
          ...
          <div className="h-full w-full bg-[#714432] flex justify-around items-center">
            ...
            <Image
              src="https://assets.splitwise.com/assets/home_page/fixtures/asset5-814c541b198b81fcf8ebe913f6a9731e6d3fe9840241ba3bb7274d15ce9cad95.png" alt="Get even more with PRO"
              className="mt-[10rem]"
              layout="intrinsic"
              width={300}
              height={100}
